    ...
    export default {
        ...
        methods: {
            ...
            confirm () {
                ...
                this.$store.dispatch('product_setting_price_template_update', data).then(function (result) {
                   this.loading = false;
                   if (result == true) {
                       this.value = false;
        ...
        mounted () {
            ...
            this.formData.unit = cloneData.unit;
            this.formData.description = cloneData.description;
